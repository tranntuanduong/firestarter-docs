...
```
### note: 
-Incase your token can be minted, please keep everything as it is.

-Incase your token can not minted, we need update code in file StakingManager.sol 
comment `rwa.mint` on the updatePool and mintExtraReward, then please deposit an initial amount to the TokenSafekepper contract
